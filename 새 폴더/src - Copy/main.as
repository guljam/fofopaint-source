package
{
    ...
    {   
        ...
        protected var worker:Worker
                    ...
                    //PNG 인코더 전역변수
                    ,workerEncodePNGBA:ByteArray = new ByteArray()
        ...
        private function makeWorker():void
        {
            ...
            workerEncodePNGBA.shareable = true;
        ...
        private function callWorkerEncodePNG(bmpd:BitmapData,bg:uint,isCaptureImage:Boolean,isTransBG:Boolean):void
        {
            ...
            setStartWorker(function():void
            {
                ...
                workerEncodePNGBA.clear();
                bmpd.copyPixelsToByteArray(new Rectangle(0,0,bmpd.width,bmpd.height),workerEncodePNGBA);
                mainToBack.send("encodePNGCapture");
                mainToBack.send(workerEncodePNGBA);
                ...
                bmpd.dispose();
                bmpd = null;
                trace('workerEncodePNGSendBA',workerEncodePNGBA.length);
            });
        }
