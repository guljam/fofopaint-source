package
{
	...
	public class topMenu extends Sprite {
		...
		public function setButtonAlphaONCaptureMode():void
		{
			capRotate.alpha = 1.0;
			capFlip.alpha = 1.0;
			capFull.alpha = 1.0;
		...
		public function setButtonAlphaOFFCaptureMode(offAlpha:Number):void
		{
			capRotate.alpha = offAlpha;
			capFlip.alpha = offAlpha;
			capFull.alpha = offAlpha;
			capTrans.alpha = offAlpha;
			capLayer1VisibleButton.alpha = offAlpha;
			capLayer2VisibleButton.alpha = offAlpha;
		}
