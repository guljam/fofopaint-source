        ...
        static private const hints:Object =
            {
                ...
                "timer": "Actual working time _ Reset [{STRING_CLICK_HOLD}]",
                ...
                "gridButton": "Grid _ Reset [right-click]",
                ...
                "dpiButton": "Current UI scale : {getUIScaleString()} _ Change UI scale _ Reset [right-click]",
                "newWindowCloseButton": "Close image view window [esc on window]",
                "newWindowButton": "Open image view window _ Move window [drag on window] _ Fit to image size [right-click on window]",
                ...
                "gridMoveLeftButton": "Move grid by 1 pixel _ Repeat [{STRING_CLICK_HOLD}], Reset [right-click]",
                "gridMoveRightButton": "Move grid by 1 pixel _ Repeat [{STRING_CLICK_HOLD}], Reset [right-click]",
                "gridMoveUpButton": "Move grid by 1 pixel _ Repeat [{STRING_CLICK_HOLD}], Reset [right-click]",
                "gridMoveDownButton": "Move grid by 1 pixel _ Repeat [{STRING_CLICK_HOLD}], Reset [right-click]",
                ...
                "colorHistoryBox": "Color history _ Move color to my palette [drag]",
                "myPaletteBox": "Add, remove, restore color [hold click] _ Swap color position [drag]",
                "rgbInfoText": "Adjust value _ Change color model [click {getRGBorHSVString()} part]",
                ...
                "myPaletteButton": "My palette _ Expand palette ON/OFF [click x 2] _ Clear palette [{STRING_CLICK_HOLD}]",
                "drawrPresetButton": "Drawr color preset _ Clear scratch pad [{STRING_CLICK_HOLD}]",
                "tegakiPresetButton": "Tegaki color preset _ Clear scratch pad [{STRING_CLICK_HOLD}]",
                "scratchPad": "Scratch pad _ Draw [drag] _ Select color [click / c /  m]",
